...
class LightModeColors {
  // PeopleDesk primary (purple)
  static const lightPrimary = Color(0xFFA855F7);
  static const lightOnPrimary = Color(0xFFFFFFFF);
  static const lightPrimaryContainer = Color(0xFFF3E8FF);
  static const lightOnPrimaryContainer = Color(0xFF2C1247);

  // Secondary: muted purple/gray
  static const lightSecondary = Color(0xFF6D28D9);
  static const lightOnSecondary = Color(0xFFFFFFFF);

  // Tertiary: supportive accent
  static const lightTertiary = Color(0xFF7C3AED);
...
class DarkModeColors {
  // Primary: Lighter purple for dark background
  static const darkPrimary = Color(0xFFD8B4FE);
  static const darkOnPrimary = Color(0xFF2C1247);
  static const darkPrimaryContainer = Color(0xFF3B1762);
  static const darkOnPrimaryContainer = Color(0xFFF3E8FF);

  // Secondary
  static const darkSecondary = Color(0xFFC4B5FD);
  static const darkOnSecondary = Color(0xFF221038);

  // Tertiary
  static const darkTertiary = Color(0xFFDDD6FE);
  static const darkOnTertiary = Color(0xFF221038);
  ...
  static const darkSurface = Color(0xFF0B0A10);
  ...
  static const darkInversePrimary = Color(0xFFA855F7);
}

/// Extra semantic colors used across the app (status chips, badges, etc.)
class AppStatusColors {
  static const success = Color(0xFF16A34A);
  static const warning = Color(0xFFF59E0B);
  static const danger = Color(0xFFEF4444);
  static const info = Color(0xFFA855F7);
}
